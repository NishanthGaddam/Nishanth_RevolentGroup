...
<script src="js/bootstrap.min.js"></script>
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="index.php"><strong>Revolent Group</strong></a></li>
...
<div class="container">
	...
	<!-- container -->
		...
		{
		echo "<h2><b>'Revolent Notice '</b></h2>
		<i> <b> It’s an opportunity for highly motivated individuals looking for a rewarding career to cross-train and become an in-demand certified professional. If you’re looking for the best way to kickstart your cloud career, this is it.</b></i>";
		}
		?>
  ...
  <div class="panel-body">
    With hubs located in the US, Canada UK and Australia, we offer a truly global solution to the lack of talent in the industry.
  </div>
</div>
